                        ...
                        <div class="d-flex align-items-center min-vh-100">
                            <div class="w-100 d-block bg-white shadow-lg rounded my-5">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="p-5">
                                            <h1 class="h5 mb-1">Welcome Back! <?= session()->get('participant_email') ?></h1>
                                            ...
                                            <form class="user">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Enter Email / Mobile no">
                                                </div>
                                                <!-- <div class="form-group">
